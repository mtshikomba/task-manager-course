            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form action="{{ route('tasks.store') }}" method="POST" class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="checkbox" value="1" name="completed" id="completed"  class="mt-1 focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded">
                    </div>

                    <div class="flex items-center justify-end mt-4">
                        <button type="submit" class="bg-indigo-500 text-white py-2 px-4 rounded-md hover:bg-indigo-600">Create Task</button>
                    </div>
                </form>
            </div>
        </div>
